...
public class SeekableTarArchiveOutputStream extends ArchiveOutputStream {
     ...
     */
    public SeekableTarArchiveOutputStream(final OutputStream os) {
     ...
     * @since 1.4
     */
    public SeekableTarArchiveOutputStream(final OutputStream os, final String encoding) {
     ...
     */
    public SeekableTarArchiveOutputStream(final OutputStream os, final int blockSize) {
